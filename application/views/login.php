...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | VECPOS ' . $this->config->item('application_version')  . ' | ' .  $this->lang->line('login_login'); ?></title>
...
<body>
	...
	<div id="login">
		...
		<h1>Vocational Point Of Sale <?php echo $this->config->item('application_version'); ?></h1>
